class PlayerArrow{
    ...
    display(){
        ...
        if(this.body.velocity.y === 0){
            topAngle = this.archerAngle + PI / 2;
        }
        else{
            topAngle = Math.atan(this.body.velocity.y/this.body.velocity.x)
        }
        Matter.Body.setAngle(this.body,topAngle);
        ...
        pop();
        if(this.velocity.x>0 && this.body.position.x>400){
